...
LANGUAGE["Class_Change_Subclass"] = "Сменить субкласс"
...
LANGUAGE["Sell_Yes"] = "Да"
LANGUAGE["Sell_No"] = "Нет"

-- Infusion
LANGUAGE["Game_Infusion"] = "Инфузия"
LANGUAGE["No infusion selected."] = "Не выбрана инфузия."
LANGUAGE["Infusion_None"] = "Нету"
LANGUAGE["Infusion_Hemo"] = "Гемо-инфузия"
LANGUAGE["Infusion_Quality"] = "Качественная инфузия"
LANGUAGE["Infusion_Rejuvenating"] = "Омолаживающая инфузия"
LANGUAGE["Infusion_Quicksilver"] = "Ртутная инфузия"
LANGUAGE["Infusion_Chrono"] = "Хроно-инфузия"
LANGUAGE["Infusion_Impaling"] = "Пронзающая инфузия"
LANGUAGE["Infusion_Septic"] = "Септическая инфузия"
LANGUAGE["Infusion_Flaming"] = "Пылающая инфузия"
LANGUAGE["Infusion_Arctic"] = "Арктическая инфузия"
LANGUAGE["Infusion_Galvanizing"] = "Гальванизированная инфузия"
LANGUAGE["Infusion_Siphoning"] = "Перекачивающая инфузия"
LANGUAGE["Infusion_Titanium"] = "Титановая инфузия"
LANGUAGE["Infusion_Concussive"] = "Сотрясающая инфузия"
LANGUAGE["Infusion_Ruination"] = "Разрушительная инфузия"
...
Преобразуется 75% урона от оружия в рубящий урон.
...
Преобразуется 75% урона от оружия в урон от молнии.
...
Увеличивает урон от оружия тем дольше, чем дольше оружие находится в руках пользователя.
...
LANGUAGE["Game_Next_Wave_Starts_In"] = "Волна начнется через %d" -- Следующая волна начнется через %d"
...
LANGUAGE["Game_HintBottomReady"] = "F3 - Магазин/Умение, F4 - Готов" -- "F2 - Инфо/Конфиг, F3 - Магазин/Умение, F4 - Готов"
LANGUAGE["Game_HintBottom"] = "F3 - Магазин/Умение, V - Выкинуть $" -- "F2 - Инфо/Конфиг, F3 - Магазин/Умение, V - Выкинуть $"
...
LANGUAGE["Rank_Not_Met"] = "Требования к Рангу Не выполнены"
...
LANGUAGE["Shop_Buy_Ammo_All"] = "Купить всё"
...
LANGUAGE["Class_Berserker"] = "Тяжеловес"
...
LANGUAGE["Class_Artificer"] = "Изобретатель"
...
Cложность: ЛЁГКАЯ
{1} увеличения скорости. ({2} за каждый уровень, до {3}).
Получайте адреналин, когда убиваете врага.
...
Регенерирует {4} здоровья за секунду.]]
...
Появляется {5} осколочная граната каждые {6} секунд, если у вас её нету.]]

LANGUAGE["Perk_ghost_base"] = [[
Класс "Призрак" сосредоточен на уничтожение боссов используя Камуфляж.
Cложность: ВЫСОКАЯ
{1} больше урона в голову. ({2} за каждый уровень, до {3}).
...
На {4} увеличена устойчивость к любому урону. ({5} за каждый уровень, до {7}).
Shift+E чтобы активировать быстрый шаг.
Вы мчитесь в направлении движения.
На 100% увеличивается уклонение при быстром шаге.
]]
...
СЛОЖНОСТЬ: СРЕДНЯЯ
Наносит нарастающее обморожение на {1} от базового урона от холода. ({1} + {2} за каждый уровень, до {3}).
На {4} увеличена устойчивость к урону от холода. ({2} за каждый уровень, до {5}).
Вооружен пустотным проектором. Можно улучшить в магазине.
ЛКМ: Копье Пустоты (5/10/20 энергии)
Выпускает снаряд, который наносит урон от холода и наносит нарастающее обморожение.
УДЕРЖИВАЙТЕ ЛКМ для получения различных эффектов.
ПКМ: Подъем Призрака (40 энергии)
Вызывает Призрака-миньона.
Миньон-призрак наносит физический урон и наносит нарастающее обморожение.
...
Вы наносите на {4} ольше урона при критическом попадании.
...
На {5} увеличен шанс критического удара в режиме безумия.
На {6} увеличено восстановление здоровья в режиме безумия.
...
ЗАЖМИТЕ ЛКМ чтобы взорвать все активные Астральные Пульсары.
...
ЗАЖМИТЕ ПКМ чтобы зарядить и обновить продолжительность всех активных Астральных Остатков.]]
...
Гипертрофия предоставляет 1% регенерации здоровья в секунду.
Вооружен биосистемой туши.
Нельзя использовать никакое другое оружие, кроме аптечек потому, что вы рукожоп.
ЛКМ: Удар
Задерживайте для мощного удара, который наносит увеличенный урон в области.]]
...
ПКМ: Поднятие муравьиного льва (40 энергии)
Создает муравьиного льва, который следует за тобой повсюду. Исцеляйте муравьиного льва чтобы ускорить эволюцию.
...
LANGUAGE["Perk_Title_Survivor_Tier_2"] = [[Импровизировать]]
...
За каждого противника которого вы убили,
...
На {1} увеличен урон в голову.
На {2} увеличена устойчивость к любому урону при полном запасе здоровья.]]
...
Враги, в которых вы поражаете баллистическим уроном, препятствоваться.
Препятствующие враги наносят на {1} уменьшенный урон.]]
...
Ослабленные враги получают на {1} увеличенный урон.]]
...
Применяемые вами дебаффы увеличивают длительность действия на {2}.]]
...
Ваше исцеление усиливается на {1}.]]
...
Игроки, которых вы исцелили, укрепляются на {1} секунд.
...
Ваше исцеление напрямую уменьшает накопление
кровотечения, разрыва и оглушения.]]
...
Врагов, которых вы убили, имеют {1} шанс создать исцеляющее облако.]]
...
Ударные взрывы увеличивают накопляющее оглушение.]]

LANGUAGE["Perk_Title_demolition_frag_cluster"] = [[Кассетная граната]]
LANGUAGE["Perk_demolition_frag_cluster"] = [[
Гранаты и ВЛУБы спавнят {1} мини-нады при детонации.
У мини-над на {2} меньше урона.]]
...
Разрывные снаряды создают дополнительный замедленный взрыв.
Замедленный взрыв наносит {1} урона от взрыва как физический урон.]]
...
Взрывы наносят от {2} до {3} текущего здоровья врагов,
в качестве дополнительного урона от взрыва.]]

LANGUAGE["Perk_Title_demolition_chain_reaction"] = [[Цепная реакция]]
LANGUAGE["Perk_demolition_chain_reaction"] = [[
Врагов, которых вы убили, имеют {1} шанс взорваться,
нанося {2} от их максимального здоровья в качестве урона от взрыва.]]
...
Урон от выстрела в голову добавляет стак до 5 раз.
Каждый стак увеличивает на 8% урон в голову.]]

LANGUAGE["Perk_Title_ghost_sniper"] = [[Снайпер]]
LANGUAGE["Perk_ghost_sniper"] = [[
На 25% увеличен Баллистический урон приседая.]]
...
Обмороженые враги получают резкую заниженную скорость действия на {1} сек.
...
Мгновенно убивает врагов с менее чем 20% здоровья.]]
...
Миньоны исцеляются {1} от их нанесенного урона, до {2} здоровья за удар.
На {3} увеличен урон миньонов когда они исцеляются.]]
...
Щит взрывается при истощении и имеет время перезарядки на {2} секунд.]]
...
У телепортированного миньона восстанавливается {1} здоровья.
Вытеснитель имеет время перезарядки на {2} секунд.]]
...
После смерти миньоны наносят {1} от их максимального здоровья,
...
Восстанавливает {1} от урона ближнего боя, до {2} здоровья за удар.
...
При успешном воздушном парировании:
  - Убирает все дебаффы и накопительные дебаффы
...
Каждый стак увеличивает на {2} устойчивость от физического урона и на {3} урон ближним боем.
Теряется стак при атаке.]]

LANGUAGE["Perk_Title_berserker_rip_and_tear"] = [[Рвать и терзать]]
LANGUAGE["Perk_berserker_rip_and_tear"] = [[
На {1} больше урона ближним боем.
Ваша атака ближним боем теперь имеет сплеш.
Урон сплешем является {2} вашего урона ближним боем.]]
...
Аура обеспечивает 1 регенерацию здоровья в секунду.]]
...
Ударная волна наносит {2} урона от молнии.]]
...
Длительность воспламенения увеличивается на {1}.]]
...
Иммунитет к урону от огню.
Поглощается {1} урона от огня, получаемого в качестве здоровья.]]

LANGUAGE["Perk_Title_cremator_entropy_shield"] = [[Энтропийный щит]]
LANGUAGE["Perk_cremator_entropy_shield"] = [[
Получитаете щит, который сводит на нет урон, наносимый врагами.
...
Урон от огня увеличивает наращивание взрыва у врагов.
Если наращивание взрыва заполнена, то создается взрыв.
Взрыв наносит {1} урона от взрыва.]]
...
Добавляется 1 максимальный заряд к быстрому шагу.
На {1} увеличен урон от ближнего боя во время быстрого шага.]]

LANGUAGE["Perk_Title_samurai_flesh_bloom"] = [[Цветение плоти]]
LANGUAGE["Perk_samurai_flesh_bloom"] = [[
Урон в ближнем бою наносит нарастающее кровотечение в области.]]
...
Добавляется 1 максимальный заряд к быстрому шагу.
Активация быстрого шага создаёт ударную волну, наносящая {1} физ. урона.
...
LANGUAGE["Perk_Title_samurai_resolution"] = [[Разрешение]]
...
Добавляется 1 максимальный заряд к быстрому шагу.
Убийство врагов добавляет 2 заряда к быстрому шагу.
Продливается длительность эффекта от быстрого шага.]]
...
Забирается 25% полученный урон в ближнем бою во время быстрого шага.]]
...
Сигнальная ракета длится {2} секунды.]]
...
LANGUAGE["Perk_Title_Artificer_Tier_2"] = [[Возмещать]]
...
LANGUAGE["Perk_Title_artificer_hallowed_bolt"] = [[Освященный болт]]
LANGUAGE["Perk_artificer_hallowed_bolt"] = [[
Открывается освященный болт для солнечной печати ({1} энергии, клавиша R).
Наносит удар по земле сверху, нанося тяжелый электрический урон по площади.
Восстанавливается здоровье убийством врага при помощи освященного болта.]]
...
Электрический урон игнорирует сопротивление электричествого урона врага.
Солнечный шар имеет зону поражения электричеством.
...
Пустотное копье будет всегда наносит сплэш урон.
Увеличивает сплэш урон у пустотного копья.]]
...
На {2} меньше затрат на подъем призрака.]]
...
с помощью пустотного копья.
Увеличивается урон в зависимости от оставшиеся энергии.]]
...
Пустотное копье наносит дополнительное нарастание обморожения.
Увеличивается урон пустотного копья по его дальности перемещения.]]

LANGUAGE["Perk_Title_necromancer_abyssal_might"] = [[Бездонная мощь]]
LANGUAGE["Perk_necromancer_abyssal_might"] = [[
+{1} к максимальному количеству живых призраков.
Призраки получают доступ к бездонному реву.]]
...
Урон от холода игнорирует сопротивление к урону от холода врага.
Открывается пустотный каскад для пустотного проектора (30 энергии, клавиша R).
Бонусы от перков к пустотному копью так же применяются на пустотный каскад.]]

LANGUAGE["Perk_Title_necromancer_necromastery"] = [[Некромастерия]]
LANGUAGE["Perk_necromancer_necromastery"] = [[
+{1} к максимальному количеству живых призраков.
Открывается умение пожирания для пустотного проектора (Клавиша R).
...
LANGUAGE["Perk_Title_gunslinger_poach"] = [[Браконьерствовать]]
LANGUAGE["Perk_gunslinger_poach"] = [[
На {1} добавлена длительность метки охотника.
Враги, убитые под меткой охотника, имеют {2} шанс выбросить поглащ. гаджеты.
Элитные враги имеют {3} дополнительный шанс выбросить гаджет.]]

LANGUAGE["Perk_Title_Gunslinger_Tier_3"] = [[Трюки]]
LANGUAGE["Perk_Title_gunslinger_quickdraw"] = [[Быстрый вынос]]
LANGUAGE["Perk_gunslinger_quickdraw"] = [[
Дается статус быстрого выноса при переключении оружия.
Урон от пистолетов и уклонение при статусе быстрого выноса увеличены на {1}.
Эффект быстрого выноса длится в течение {2} секунд.]]
...
Метка охотника снимает мутации с врагов на {1} секунд.
...
На {1} увеличен урон при критическом попадании.
Атаки ближнего боя удаляют мутацию немезиды у врагов.]]
...
Даётся брутальность поражая врага атаками ближнего боя, до пяти стаков.
...
LANGUAGE["Perk_Title_Warlock_Tier_1"] = [[Преображать]]
...
LANGUAGE["Perk_Title_warlock_coalesce"] = [[Объединяться]]
LANGUAGE["Perk_warlock_coalesce"] = [[
+{1} к максимальному количеству активных Астральных Осколков.
Позволяет нацеливать Астральный Пульсар на Астральные Осколки.
Нацеленный Астральный Осколок прикрепляется к Пульсару при контакте.]]

LANGUAGE["Perk_Title_Warlock_Tier_2"] = [[Направлентие]]
...
ПКМ для продвижения, стоимостью 25% здоровья, и получить 1 стак Б.Д, до 5.
Каждый стак Б.Д увелич. на {3} урон от ближ. боя, но снимает 5 здоровья.]]
...
завершено. Селезенка восстанавливается каждые 5 секунд.]]
...
Прибавляет +{1} к максимальному количеству Гипертрофических стаков.
Нажмите пробел в воздухе для спуска, нанося физ. урон в области,
...
игрокам в области. Эффект длится в течение {2} сек. и имеет перезарядку 10 сек.]]
...
Песчаный плащ длится в течение 5 секунд.]]
...
Пожиратель плоти позволяет игроку высасывать {1} урона, до 5 за каждый удар.
Пожиратель плоти позволяет мурав. львам высасывать 5 единиц урона.]]
...
Только используется субклассом "Туша"
  ...
  ЛКМ: Удар
  Зажмите для мощного удара который наносит увеличенный урон в области.
]]
...
Манипулирует отрицательными энергетическими полями.
  ...
  У вас может быть не более 5 активных Астральных Остатков.
  ЗАЖМИТЕ ПКМ чтобы зарядить и обновить продолжительность
 всех активных Астральных Остатков.
]]

LANGUAGE["Item_Pheropod"] = [[Феропод]]
LANGUAGE["Item_Desc_Pheropod"] = [[
Только используется субклассом "Инкубатор"
...
Исцеляет врагов и наносит урон врагам.
]]
...
Наносит 100 урона от электричества.
]]
...
LANGUAGE["Item_Void Projector"] = [[Пустотный проектор]]
LANGUAGE["Item_Desc_Void Projector"] = [[
Пустотный проектор. Может использоваться только подклассом "Некромант".
Манипулирует темной энергией, вызывая гипотермию и вызывая сущности.
ЛКМ: Копье Пустоты (5/10/20 энергии)
...
НАЖМИТЕ ПКМ, чтобы призвать призраков на свою сторону.
]]

LANGUAGE["Item_Solar Seal"] = [[Солнечная печать]]
LANGUAGE["Item_Desc_Solar Seal"] = [[
Солнечная печать. Может использоваться только подклассом "Изобретатель".
Манипулирует солнечной энергией, чтобы сеять разрушения.
Оснащен солнечной печатью. Можно прокачать в магазине.
ЛКМ: Солнечный шар (5/10/20 энергии)
Выпускает снаряд, который наносит урон от огня.
УДЕРЖИВАЙТЕ ЛКМ для получения различных эффектов.
ПКМ: Солнечная буря (5/10/20 энергии)
...
Первичный огонь создает самонаводящиеся рикошетирующие выстрелы.
...
Зажмите ПКМ чтобы распиливать врагов насквозь.
]]
...
На 20% увеличена скорость в течение 30 секунд.
]]

LANGUAGE["Gadget_gadget_damage_shard"] = [[Осколок урона]]
LANGUAGE["Gadget_Desc_gadget_damage_shard"] = [[
На 20% увеличен любой урон в течение 30 секунд.
]]
...
На 25% увеличен любой урон.
]]

LANGUAGE["Gadget_gadget_resistance_booster"] = [[Усилитель сопротивления]]
LANGUAGE["Gadget_Desc_gadget_resistance_booster"] = [[
На 20% увеличено глобальное сопротивление к урону.
]]

LANGUAGE["Gadget_gadget_ultimate_booster"] = [[Предельный усилитель]]
LANGUAGE["Gadget_Desc_gadget_ultimate_booster"] = [[
На 15% увеличена скорость передвижения.
На 15% увеличено максимальное здоровье.
На 15% увеличен любой урон.
На 15% увеличено глобальное сопротивление к урону.
]]
...
LANGUAGE["Gadget_gadget_healing_beam"] = [[
...
Эффект заканчивается после после нанесения урона врагу.
]]
...
Бросается вперед, нанося 100 рубящего урона всем врагам на пути.
