...
SWEP.UseHands = true
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo2_thompson.vtf")
    killicon.Add("arccw_horde_thompson_expl", "arccw/weaponicons/arccw_bo2_thompson", Color(0, 0, 0, 255))
end
...
SWEP.MuzzleVelocity = 285 -- projectile or phys bullet muzzle velocitya
-- IN M/S
...
SWEP.Primary.ClipSize = 22 -- DefaultClip is automatically set.
SWEP.ReducedClipSize = 22
