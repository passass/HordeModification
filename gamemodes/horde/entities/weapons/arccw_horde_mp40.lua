...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo3_mp40.vtf")
    killicon.Add("arccw_horde_mp40", "arccw/weaponicons/arccw_bo3_mp40", Color(0, 0, 0, 255))
end
SWEP.Damage = 48
