...
SWEP.Slot = 1
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo2_fnp45.vtf")
    killicon.Add("arccw_horde_tac45", "arccw/weaponicons/arccw_bo2_fnp45", Color(0, 0, 0, 255))
end
SWEP.UseHands = true
...
SWEP.Attachments = {
    { --1
		...
		Installed = "go_optic_hunter", Integral=true
    },
    { --3
        PrintName = "Muzzle",
    ...
    { --5
        ...
        MergeSlots = {3},
		Installed = "go_laser_surefire", Integral=true
    },
    { --6
        PrintName = "Ammo Type",
