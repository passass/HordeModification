...
SWEP.Slot = 5 
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_go_nade_frag.vtf")
    killicon.Add("arccw_horde_nade_frag", "arccw/weaponicons/arccw_go_nade_frag", Color(0, 0, 0, 255))
end
...
SWEP.ShootEntity = "arccw_horde_go_frag"--"arccw_thr_go_frag"
