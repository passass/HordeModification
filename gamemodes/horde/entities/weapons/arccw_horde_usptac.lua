...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_usp.vtf")
    killicon.Add("arccw_horde_usptac", "arccw/weaponicons/arccw_mw3e_usp", Color(0, 0, 0, 255))
end
SWEP.Damage = 66
SWEP.DamageMin = 60
SWEP.RangeMin = 10
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Installed = "muzz_brake", Integral = true
    }, --2
    {
        PrintName = "Tactical",
        ...
        MergeSlots = {7,8,9}, Installed = "tac_mw2_x400", Integral = true
    }, --3
    {
        PrintName = "Underbarrel",
        Slot = {"mw3_knife"}, Installed = "tac_mw3_knife", Integral = true
    }, --4
    {
        PrintName = "Perk",
        Slot = "perk"
