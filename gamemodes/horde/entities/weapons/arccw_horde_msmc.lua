...
SWEP.Slot = 2
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo2_msmc.vtf")
    killicon.Add("arccw_horde_msmc", "arccw/weaponicons/arccw_bo2_msmc", Color(0, 0, 0, 255))
end
SWEP.UseHands = true
