...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_horde_trenchgun")
    killicon.Add("arccw_hordeext_trenchgun", "arccw/weaponicons/arccw_horde_trenchgun", Color(0, 0, 0, 255))
end
