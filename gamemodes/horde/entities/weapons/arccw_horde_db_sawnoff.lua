...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_db_sawnoff.vtf")
    killicon.Add("arccw_horde_db_sawnoff", "arccw/weaponicons/arccw_db_sawnoff", Color(0, 0, 0, 255))
end
