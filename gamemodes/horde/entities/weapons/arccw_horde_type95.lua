...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo2_type95.vtf")
    killicon.Add("arccw_bo2_type95", "arccw/weaponicons/arccw_bo2_type95", Color(0, 0, 0, 255))
end
SWEP.Slot = 2
