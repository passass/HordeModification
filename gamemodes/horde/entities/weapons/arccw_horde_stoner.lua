...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo1_stoner.vtf")
    killicon.Add("arccw_horde_stoner", "arccw/weaponicons/arccw_bo1_stoner", Color(0, 0, 0, 255))
end
SWEP.Damage = 33
