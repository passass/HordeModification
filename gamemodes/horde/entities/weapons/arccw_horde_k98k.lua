...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_waw_k98k")
    killicon.Add("arccw_horde_k98k", "arccw/weaponicons/arccw_waw_k98k", Color(0, 0, 0, 255))
end
