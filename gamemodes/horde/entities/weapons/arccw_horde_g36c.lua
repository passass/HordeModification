...
SWEP.Slot = 2
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_g36.vtf")
    killicon.Add("arccw_horde_g36_smg", "arccw/weaponicons/arccw_mw3e_g36", Color(0, 0, 0, 255))
end
SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arccw/c_mw3e_g36.mdl"
SWEP.WorldModel = "models/weapons/arccw/w_mw3e_g36.mdl"
SWEP.MirrorWorldModel = "models/weapons/arccw/w_mw3e_g36.mdl"
