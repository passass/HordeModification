...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_deagle")
    killicon.Add("arccw_horde_deagle_xix", "arccw/weaponicons/arccw_mw3e_deagle", Color(0, 0, 0, 255))
end
SWEP.Slot = 1
...
SWEP.Hook_ModifyBodygroups = function(wep, data)
    ...
    local camo = 0
    if wep.Attachments[6].Installed == "mw3e_cosmetic_deagle_silver" then camo = 1
    elseif wep.Attachments[6].Installed == "mw3e_cosmetic_deagle_classic" then camo = 1
    elseif wep.Attachments[6].Installed == "mw3e_cosmetic_deagle_classic_gold" then camo = 2
    elseif wep.Attachments[6].Installed == "mw3e_cosmetic_deagle_twotone" then camo = 1
