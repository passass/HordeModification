...
SWEP.DefaultSkin = 0
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_pm9.vtf")
    killicon.Add("arccw_horde_pm9", "arccw/weaponicons/arccw_mw3e_pm9", Color(0, 0, 0, 255))
end
SWEP.Damage = 26
SWEP.DamageMin = 21
SWEP.RangeMin = 10
