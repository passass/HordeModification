...
SWEP.Slot = 2
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo2_an94.vtf")
    killicon.Add("arccw_horde_an94", "arccw/weaponicons/arccw_bo2_an94", Color(0, 0, 0, 255))
end
SWEP.UseHands = true
