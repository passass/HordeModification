...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_ak47.vtf")
    killicon.Add("arccw_horde_ak47supmod", "arccw/weaponicons/arccw_mw3e_ak47", Color(0, 0, 0, 255))
end
SWEP.Damage = 67
