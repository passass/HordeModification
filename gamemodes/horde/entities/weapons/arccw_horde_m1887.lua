...
SWEP.UseHands = true
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_m1887.vtf")
    killicon.Add("arccw_horde_m1887", "arccw/weaponicons/arccw_mw3e_m1887", Color(0, 0, 0, 255))
end
