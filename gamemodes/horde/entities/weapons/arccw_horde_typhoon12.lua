...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        LHIKOut = .8, LHIKEaseOut = .5,
        SoundTable = {
            {t = 9 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 38 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.WpnUp")},
            {t = 40 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 41 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.ClipOut")},
            {t = 66 * .8 / 30, s = Sound("TFA_INS2.Holster")},
            {t = 81 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 114 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.ClipMove")},
            {t = 118 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.ClipIn")},
            {t = 119 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 141 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
        }
    },
    ["reload_empty"] = {
        ...
        SoundTable = {
            {t = 7 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 37 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.WpnUp2")},
            {t = 51 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.ClipOut2")},
            {t = 52 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 64 * .8 / 30, s = Sound("TFA_INS2.Holster")},
            {t = 98 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 110 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.ClipMove")},
            {t = 114 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 115 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.ClipIn2")},
            {t = 128 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 144 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 145 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.BoltBack2")},
            {t = 154 * .8 / 30, s = Sound("TFA_INS2.WF_SHG53.BoltForward2")},
            {t = 155 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
            {t = 175 * .8 / 30, s = Sound("TFA_INS2.LeanIn")},
        }
    },
    ["holster"] = {
		Source = "base_holster",
