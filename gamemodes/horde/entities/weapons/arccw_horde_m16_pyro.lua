...
SWEP.Damage = 29
SWEP.Horde_BurnDamage = 2
SWEP.DamageMin = 19
SWEP.RangeMin = 1300 * 0.025  -- GAME UNITS * 0.025 = METRES
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Integral = true,
        Installed = "arccw_horde_m203_pyro",
    },
    {
        PrintName = "Tactical",
        Slot = "tac",
...
SWEP.Hook_TranslateAnimation = function(wep, anim)
	...
	local attthing
		if 		attached == "arccw_horde_m203_pyro" 		then attthing = 1
