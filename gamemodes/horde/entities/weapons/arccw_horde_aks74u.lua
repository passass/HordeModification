...
SWEP.Slot = 2
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_ak74u.vtf")
    killicon.Add("arccw_horde_aks74u", "arccw/weaponicons/arccw_mw3e_ak74u", Color(0, 0, 0, 255))
end
SWEP.UseHands = true
