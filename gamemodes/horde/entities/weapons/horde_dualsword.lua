...
if CLIENT then
    ...
    killicon.Add("horde_dualsword", "entities/horde_dualsword", Color(0, 0, 0, 255))
end
...
sound.Add({
	...
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/dual_sword/swing_1.wav", "weapons/tfa_cso/dual_sword/swing_2.wav", "weapons/tfa_cso/dual_sword/swing_3.wav", "weapons/tfa_cso/dual_sword/swing_4.wav", "weapons/tfa_cso/dual_sword/swing_5.wav" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "DualSword.Stab",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/dual_sword/stab_1.wav", "weapons/tfa_cso/dual_sword/stab_2.wav" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "DualSword.HitFleshSlash",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/dual_sword/hit_1.wav", "weapons/tfa_cso/dual_sword/hit_2.wav", "weapons/tfa_cso/dual_sword/hit_3.wav" },
	['pitch'] = {95,105}
})
sound.Add({
...
local light_dmg, hard_dmg = 40, 175	

SWEP.Primary.Attacks = {
	{
		['act'] = ACT_VM_HITLEFT, -- Animation; ACT_VM_THINGY, ideally something unique per-sequence
		['len'] = 25*4, -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		['dir'] = Vector(-180,0,15), -- Trace dir/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		['dmg'] = light_dmg, --This isn't overpowered enough, I swear!!
...
SWEP.Secondary.Attacks = {
	{
		...
		['len'] = 30*4.5, -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		['dir'] = Vector(0,90,0), -- Trace dir/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		['dmg'] = hard_dmg - 50, --Nope!! Not overpowered!!
		['dmgtype'] = DMG_SLASH, --DMG_SLASH,DMG_CRUSH, etc.
		['delay'] = 0.035, --Delay
		['spr'] = true, --Allow attack while sprinting?
		['snd'] = "TFABaseMelee.Null", -- Sound ID
	...
	},
	{
		...
		['len'] = 32*4.5, -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		['dir'] = Vector(0,90,0), -- Trace dir/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		['dmg'] = hard_dmg + 25, --Nope!! Not overpowered!!
		['dmgtype'] = DMG_SLASH, --DMG_SLASH,DMG_CRUSH, etc.
		['delay'] = 0.05, --Delay
		['spr'] = true, --Allow attack while sprinting?
		['snd'] = "TFABaseMelee.Null", -- Sound ID
