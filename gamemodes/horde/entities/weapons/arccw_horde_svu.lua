...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo2_svu.vtf")
    killicon.Add("arccw_horde_svu", "arccw/weaponicons/arccw_bo2_svu", Color(0, 0, 0, 255))
end
SWEP.Slot = 3
