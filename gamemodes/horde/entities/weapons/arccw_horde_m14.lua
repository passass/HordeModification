...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo1_m14.vtf")
    killicon.Add("arccw_horde_m14", "arccw/weaponicons/arccw_bo1_m14", Color(0, 0, 0, 255))
end
