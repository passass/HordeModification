...
SWEP.UseHands = true
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_mw3e_mp5.vtf")
    killicon.Add("arccw_horde_mp5_sup_med", "arccw/weaponicons/arccw_mw3e_mp5", Color(0, 0, 0, 255))
end
