...
function ENT:Horde_StartTimeStop()
	timer.Pause("timer_range_finished_abletorange"..self:EntIndex())
	timer.Pause("timer_range_finished"..self:EntIndex())
end

function ENT:Horde_EndTimeStop() 
	timer.UnPause("timer_range_finished_abletorange"..self:EntIndex())
	timer.UnPause("timer_range_finished"..self:EntIndex())
end
