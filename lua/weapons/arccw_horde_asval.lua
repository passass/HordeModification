...
SWEP.Animations = {
    ...
    ["reload"] = {
        Source = "base_reload", Mult = .8, MinProgress = 2.85, ForceEnd = true,
        --Time = 2,
        ...
        SoundTable = {
            {t = 14 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Magout")},
            {t = 21 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Slideforward")},
            {t = 58 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Magin")},
        },
    },
    ["reload_empty"] = {
        Source = "base_reloadempty", Mult = .8, MinProgress = 3.75, ForceEnd = true,
        TPAnim = ACT_HL2MP_GESTURE_RELOAD_AR2,
        LHIK = true,
        LHIKIn = .4, LHIKEaseIn = .2,
        LHIKOut = .5, LHIKEaseOut = .5,
        SoundTable = {
            {t = 1 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Slideforward")},
            {t = 28 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Magout")},
            {t = 56 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Magin")},
            {t = 90 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Boltback")},
            {t = 100 * .8 / 30, s = Sound("TFA_AT_AS_VAL.Boltrelease")},
        },
    },
}